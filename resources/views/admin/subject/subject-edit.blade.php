 <form action="{{ url('dashboard/subject', $subject->id) }}" method="POST" id="formEditStudent">
     @csrf
     @method('PUT')
     ...
     <div class="grid gap-4 mb-4 sm:grid-cols-1">
         ...
         <div>
             ...
             <input name="description" id="edit_description" type="text" placeholder="Masukkan nama siswa"
                 class="w-full p-2 mt-1 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
         </div>
