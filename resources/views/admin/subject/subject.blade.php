        ...
        <div class="flex items-center gap-3">
            ...
            <div id="dropdown1" class="z-10 hidden bg-white border border-default-medium rounded-base shadow-lg w-44">
                <ul class="p-2 text-sm text-body font-medium" aria-labelledby="dropdownDefaultButton">
                    <li>
                        <a href="/export/excel/subject" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Excel</a>
                    </li>
                    <li>
                        <a href="/export/csv/subject" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">CSV</a>
                    </li>
                    <li>
                        <a href="/export/pdf/subject" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">PDF</a>
                    </li>
                    <li>
                        <a href="/export/print/subject" target="_blank" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Print</a>
                    </li>
                </ul>
            </div>
        </div>
