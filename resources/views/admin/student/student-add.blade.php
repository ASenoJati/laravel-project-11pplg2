<form class="space-y-4" action="{{ url('dashboard/student') }}" method="POST">
    @csrf
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama</label>
            <input name="name" type="text" placeholder="Masukkan nama siswa"
        ...
        <div class="md:col-span-2">
            ...
            <select
                name="gender" class="w-full p-2 mt-1 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
        ...
        <div class="md:col-span-2">
            ...
            <textarea name="address" rows="2" placeholder="Masukkan alamat siswa"
