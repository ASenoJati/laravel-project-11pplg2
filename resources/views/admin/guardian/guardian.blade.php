        ...
        <div class="flex items-center gap-3">
            ...
            <div id="dropdown1" class="z-10 hidden bg-white border border-default-medium rounded-base shadow-lg w-44">
                <ul class="p-2 text-sm text-body font-medium" aria-labelledby="dropdownDefaultButton">
                    <li>
                        <a href="/export/excel/guardian" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Excel</a>
                    </li>
                    <li>
                        <a href="/export/csv/guardian" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">CSV</a>
                    </li>
                    <li>
                        <a href="/export/pdf/guardian" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">PDF</a>
                    </li>
                    <li>
                        <a href="/export/print/guardian" target="_blank" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Print</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <table id="studentTable"
                ...
                <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="student-row hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:shadow-inner transition-all cursor-pointer"
                        ...
                        <td class="px-4 py-3 text-gray-700 dark:text-gray-400">{{ $guardian->email }}</td>
                        <td class="px-4 py-3 text-gray-700 dark:text-gray-400">{{ $guardian->phone }}</td>
                        <td class="px-4 py-3 text-gray-700 dark:text-gray-400">{{ $guardian->job }}</td>
                        <td>
    ...
    <div id="updateProductModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto backdrop-blur-sm bg-black/60 overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-900 sm:p-5">
                ...
                @include('admin.guardian.guardian-edit')
            </div>
        </div>
    </div>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            editButtons.forEach(btn => {
                btn.addEventListener('click', async () => {
                    ...
                    let res = await fetch(`guardian/${id}`);
                    let data = await res.json();

                    document.getElementById('formEditStudent').action =
                        "/dashboard/guardian/" + id;
                    ...
                    document.getElementById('edit_job').value = data.job;
